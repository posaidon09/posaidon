		...
		<div className="min-h-screen overflow-auto">
			<div className="flex flex-col items-center justify-center gap-10 my-[15%]">
				<a
					...
					target="_blank"
					className="bg-zinc-900 rounded-2xl flex flex-row gap-3 transition-all duration-200 cursor-pointer hover:scale-110 w-[500px] p-3"
				>
					<img
					...
					<img
						...
						className="border-green-600 border-[3px] h-28 w-28 rounded-full"
					/>
					<h4 className="text-gray-200 ml-6 mt-10 text-3xl">posaidon_</h4>
				</a>
				<a
				...
				>
					...
					<img
						...
						className="border-green-600 border-[3px] h-28 w-28 rounded-full"
					/>
					<h4 className="text-gray-200 ml-6 mt-10 text-3xl">posaidon09</h4>
				</a>
			</div>
		</div>
	);
